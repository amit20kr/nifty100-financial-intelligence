...
if not df_ratios.empty:
    ...
    if not df_sectors.empty:
        ...
        non_fin_ratios = df_ratios_sectors[
            df_ratios_sectors["broad_sector"] != "Financials"
        ]
...
with col_table:
    ...
    if not df_scores.empty and not df_companies.empty and not df_sectors.empty:
        ...
        if "broad_sector" not in top5.columns:
            top5 = top5.merge(
                df_sectors[["company_id", "broad_sector"]], on="company_id", how="left"
            )
