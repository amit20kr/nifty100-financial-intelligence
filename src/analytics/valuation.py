...
def generate_valuation_reports(db_path: str = "db/nifty100.db", output_dir: str = "output"):
    """
    ...
    with sqlite3.connect(db_path) as conn:
        ...
        median_5yr = df_5yr.groupby('company_id').apply(get_median_if_valid).reset_index(name='5yr_median_PE')
    ...
    # FCF Yield
    df_base['FCF_yield_pct'] = (df_base['free_cash_flow_cr'] / df_base['market_cap_crore']) * 100
    
    # PE vs Sector Median Pct
    df_base['PE_vs_sector_median_pct'] = ((df_base['pe_ratio'] / df_base['sector_median_PE']) - 1) * 100
